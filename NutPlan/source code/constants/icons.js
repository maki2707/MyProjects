...
const recipes = require("../assets/icons/recipe-icon.png")
const recipeList = require("../assets/icons/recipeList.png")
const grocery = require("../assets/icons/grocery-icon.jpg")
const pantry = require("../assets/icons/pantry.png")
